  ...
  return (
     <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      <div className="flex flex-col sm:flex-row items-center gap=4 mt-4">
        <a
          href="#contact"
          className="px-5 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 transition-transform transform hover:scale-105 hover:bg-black-200 gap-2"
        >
        ...
        <a
          ...
          download
          className="px-10 py-3 border rounded-full border-grey-500 flex items-center transition-transform transform hover:scale-105 hover:bg-gray-200 gap-2"> 
